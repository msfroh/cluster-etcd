 ...
 */
package org.opensearch.cluster.controller.election;
...
import static org.opensearch.cluster.controller.config.Constants.LEADER_ELECTION_TTL_SECONDS;
...
public class LeaderElection {
    private static final Logger log = LogManager.getLogger(LeaderElection.class);
    ...
    public CompletableFuture<Boolean> startElection() {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                LeaseGrantResponse leaseGrant = etcdClient.getLeaseClient().grant(LEADER_ELECTION_TTL_SECONDS).get();
                ...
                election.campaign(electionKeyBytes, leaseId, nodeIdBytes).thenAccept(leaderKey -> {
