...
public class IndexMetadata implements ToXContentObject {
    ...
    public IndexMetadata(
        boolean isIndexTemplateType,
        List<AliasConfig> aliases,
        String idField,
        String versionField,
        BatchIngestionSource batchIngestionSource,
    ...
    public static class AliasConfig implements ToXContentObject {
        ...
        public boolean equals(Object obj) {
            ...
            return java.util.Objects.equals(name, that.name) && java.util.Objects.equals(matchStrategy, that.matchStrategy);
        }
    ...
    public static class LiveIngestionSource implements ToXContentObject {
        ...
        public boolean equals(Object obj) {
            ...
            return java.util.Objects.equals(kafkaTopic, that.kafkaTopic) && java.util.Objects.equals(cluster, that.cluster);
        }
    ...
    @Override
    public int hashCode() {
        return java.util.Objects.hash(isIndexTemplateType, aliases, idField, versionField, batchIngestionSource, liveIngestionSource);
    }
}
