...
import static org.opensearch.cluster.controller.metrics.MetricsConstants.PLANNED_INGEST_SU_ALLOCATION_METRIC_NAME;
import static org.opensearch.cluster.controller.metrics.MetricsConstants.PLANNED_SEARCH_SU_ALLOCATION_METRIC_NAME;
...
public class ShardAllocator {
     ...
     */
    void setAllocationDecisionEngine(AllocationDecisionEngine allocationDecisionEngine) {
