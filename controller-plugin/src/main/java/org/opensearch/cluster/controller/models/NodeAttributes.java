...
public final class NodeAttributes {
    ...
    public static final Map<String, String> COORDINATOR_ATTRIBUTES = Map.of(NODE_DATA, "false", NODE_INGEST, "false", NODE_MASTER, "true");

    public static final Map<String, String> PRIMARY_ATTRIBUTES = Map.of(NODE_DATA, "true", NODE_INGEST, "true", NODE_MASTER, "false");

    public static final Map<String, String> REPLICA_ATTRIBUTES = Map.of(NODE_DATA, "true", NODE_INGEST, "false", NODE_MASTER, "false");
